The verification environment is compiled and run using VCS.<br>Run make to compile and run the test bench and generate the coverage reports.<br>The design and verification requirements are in ALU.xlsx.
